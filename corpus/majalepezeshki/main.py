...
save_path = Path("majalepezeshki")
save_path.mkdir(exist_ok=True)

sitemap_url = "https://majalepezeshki.ir/post-sitemap.xml"
...
article_links = [loc.text for loc in root.findall(".//{*}loc") if loc.text.startswith("https://majalepezeshki.ir/article")]
